...
void test_initialization(void)
{
	...
	*/
	std::cout <<"the default value of global variables is " << global << std::endl;   // 0
	int local;  // uninitialized var
	std::cout <<"the default value of local variables is  " <<local << std::endl;  // garbage 
